...
const PERMISSIONS = {
  ...
  org: [
    ['migrations.view', 'View data-migration batches'],
    ['migrations.manage', 'Run data migration (opening balances)'],
  ...
  for (const roleCode of [
    ...
    await pool.query(
      `INSERT INTO role_permissions (role_id, permission_id)
       ...
       ON CONFLICT DO NOTHING`,
      [roleCode, ['products.view', 'dividends.view', 'notifications.view', 'branches.view', 'migrations.view']],
    );
  }
